...
class IntelRAPL:
        ...
        for file in files:
            ...
            with open(path) as f:
                ...
                try:
                    ...
                    print(f"We will read Intel RAPL files at {rapl_file}")
    ...
    def get_cpu_details(self, duration: Time, **kwargs) -> Dict:
        ...
        print(f"get_cpu_details {self.cpu_details}")
        return cpu_details
    ...
    def get_static_cpu_details(self) -> Dict:
        ...
        """
        print(f"get_static_cpu_details {self.cpu_details}")
...
class TDP:
    ...
    def _main(self) -> Tuple[str, int]:
        ...
        """
        cpu_model_detected = self.detect_cpu_model()
